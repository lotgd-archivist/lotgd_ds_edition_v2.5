    ...
    case 'anzeige':
        ...
        else
        {
            ...
            if (db_num_rows($result)>0)
            {
                ...
                {
                    output("`&`n`qDu schaust in deinen Beutel und stellst fest daß du nicht genug Gold dabei hast.`n`QUntertänigst entschuldigst du dich beim Gerichtsdiener und verlässt das Gebäude.`n`n");
