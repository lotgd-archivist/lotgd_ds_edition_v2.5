...
// 11072004
// 20.06.2006 Tippfehler (Forum 18.6.06) beseitigt
...
if ($_GET['op']=="" || $_GET['op']=="search"){
	...
	//check_align();
	output("`GDu verbringst einen großen Teil des Tages damit, diesem gefallenen Abenteurer ein Grab zu schaufeln und ihm ein ordentliches Begräbnis zukommen zu lassen. ");
