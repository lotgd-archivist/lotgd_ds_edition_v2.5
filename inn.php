    ...
    case "msgboard":
        ...
        if ($_GET['act']=="add1")
        {
            ...
            if ($_GET['board_action'] == "")
            {
                ...
                output("sind viele seiner Kunden der Kunst des Schreibens nicht mächtig. 
                		\"`%Das macht dann `^$msgprice`% Gold. Wie soll die Nachricht lauten?`0\"`n`n");
        ...
        else
        {
            ...
            output("\"`%Du möchtest eine Nachricht am schwarzen Brett hinterlassen, ja? Wie lang soll die Nachricht denn dort zu sehen sein?`0\" fragt dich Cedrik fordernd und nennt die Preise.
            			`nZuvor weist er dich noch darauf hin, dass Schlüsselgesuche, Fragen nach Ausbauhilfen und überhaupt alles, was mit Häusern und Schlüsseln zu tun hat, 
                		am Immobilienmarkt besser aufgehoben wäre!`n");
            addnav('Lieber zum Immobilienmarkt..','immo_board.php');
