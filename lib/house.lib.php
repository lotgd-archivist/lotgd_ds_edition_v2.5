 ...
 * @param int AcctID des Schlüsselbesitzers
 * @param int Typ des Schlüssels (Privatraum etc...)
 ...
 * @param int Typ des Schlüssels (Privatraum etc...)
 * @param int Wert der Value1-Variable
 * @param int Begrenzung der zu löschenden Schlüssel
...
$value2=$state-($value1*10);
 ...
 switch ($state) {
  ...
  break;
  case 6 :
  $expr="`@Unbebautes Grundstück";
  $expr2="`@ein unbebautes Grundstück";
  break;
 }
$expr=$expr."`0";
