...
case 2 :
    ...
    else if ($_GET['op']=="closer")
    {
        ...
        insertcommentary($session['user']['acctid'],'/me nähert sich neugierig dem Dorfbrunnen.`0','village');
    ...
    else if ($_GET['op']=="helpme")
    {
        ...
        case 1 :
            ...
            insertcommentary(1,'/msg `7Die schnelle Hilfe der Helden auf dem Dorfplatz rettet `&'.$session['user']['name'].'`7 das Leben und der Strang zieht sich in den Brunnen zurück.`0','village');
